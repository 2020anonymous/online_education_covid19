...
# phase_indicator (which takes value 0, 1 and 2, representing pre-pandemic phase, initial rising phase, and 'new normal' phase respectively), 
...
# obtain coefficients of phase_indicator for initial rising phase and 'new normal' phase
...
# obtain differential effect among females and males, during initial rising phase and 'new normal' phase respectively
...
# obtain differential effect among females and males, during initial rising phase and 'new normal' phase respectively, within each age group

...
# This script includes the codes to fit the models in paper "Evidence from Internet search data shows increasing interest in online education in response to the COVID-19 pandemic". The script runs in R (version 3.4.1).

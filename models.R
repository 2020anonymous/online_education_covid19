...
# This script includes the codes to fit the models in paper "Evidence from Internet search data shows increasing interest in online education during the COVID-19 pandemic, with females showing a greater increase than males". The script runs in R (version 3.4.1).
